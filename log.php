                        ...
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                ...
                                <div class="ml-md-auto py-2 py-md-0">
                                    <a href="#" class="btn btn-white btn-border btn-round mr-2">Jl. Soekarno Hatta, RT.7/RW.7, Tlogosari Kulon, Kec. Pedurungan, Kota Semarang, Jawa Tengah 59160
                                ...
                                <div class="card-body">
                                    <form action="" method="post">
                                        <div class="form-group form-floating-label">
                                            <input name="username" type="email" class="form-control input-border-bottom" required autocomplete="off">
                                        ...
                                        <div class="form-group">
                                            <button class="btn btn-primary btn-block" type="submit"><i class="flaticon-up-arrow-2"></i> Login</button>
                                            <a href="../index.php" class="btn btn-danger btn-block"><i class="flaticon-back"></i> Back</a>
                                        </div>
                                    </form>
            ...
            <footer class="footer">
                <div class="container">
                    <div class="copyright ml-auto">
                        &copy; <?php echo date('Y'); ?> Absensi Mahasiswa.
                    </div>
                </div>
            </footer>
